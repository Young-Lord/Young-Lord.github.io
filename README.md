...
博客基于[MIT License](https://github.com/Young-Lord/young-lord.github.io/blob/master/LICENSE)开源于[GitHub](https://github.com/Young-Lord/young-lord.github.io)。
...
- prismjs使用[UNPKG](unpkg.com)加速
- 删去layout中的404页（因为只需要引入js脚本）

### 2019-06-28 v2.2.0

- 博客结构微调
- 将大部分博客用到的jscdn换成UNPKG，感谢其提供的加速服务~
- 留言板加入友链
